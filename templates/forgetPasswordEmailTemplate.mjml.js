export const forgotPasswordPinTemplate = (name, resetPin) => `
<mjml>
  <mj-head>
      ...
      <mj-section background-color="#ffffff" border-radius="12px" padding="40px 24px">
        <mj-column>
          ...
          <mj-text align="center" color="#555555" padding-bottom="20px">
            Use the code below to reset your password. This code will expire in 2 hours.
          </mj-text>

          <mj-text align="center" padding="10px 0">
            <span class="pin-box">${resetPin}</span>
          </mj-text>
